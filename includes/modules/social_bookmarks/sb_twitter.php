...
*/
  ...
  class sb_twitter {
    ...
    function getOutput() {
      return '<a href="http://twitter.com/home?status=' . urlencode(osc_href_link('products', 'id=' . $_GET['id'], 'NONSSL', false)) . '" target="_blank"><img src="' . DIR_WS_IMAGES . 'social_bookmarks/' . $this->icon . '" title="' . osc_output_string_protected($this->public_title) . '" alt="' . osc_output_string_protected($this->public_title) . '" /></a>';
    }
